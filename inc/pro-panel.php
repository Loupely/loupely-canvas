...
function lc_render_pro_panel() {
    ...
    <style>
        ...
        .lc-pro-panel .lc-pro-eyebrow { margin:0 0 6px; font-size:11px; font-weight:600; letter-spacing:0.12em; text-transform:uppercase; color:#5C7F68; }
    ...
    <div class="lc-pro-panel">
        <p class="lc-pro-eyebrow"><?php echo esc_html__( 'Free starter kit', 'loupely-canvas' ); ?></p>
        ...
        <p class="lc-pro-text is-last"><?php echo esc_html__( 'The download also includes a file you import into Loupely Canvas Pro to turn those components into named snippets you reuse across a site. The kit is free, like the theme, which is complete on its own. Pro is the optional upgrade for running real multi page sites.', 'loupely-canvas' ); ?></p>
